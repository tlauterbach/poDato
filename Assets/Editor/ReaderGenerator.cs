...
public class ReaderGenerator {
	...
	private static readonly List<string> m_primitiveBodies = new List<string>() {
		...
		"return DoOptionalReadOnlyList(name, ref value, TaterTo{0});",
		...
		"return DoOptionalReadOnlyList(name, ref value, TaterTo{0}Proxy<T>);",
		...
		"DoRequiredReadOnlyList(name, ref value, TaterTo{0});",
		...
		"DoRequiredReadOnlyList(name, ref value, TaterTo{0}Proxy<T>);",
