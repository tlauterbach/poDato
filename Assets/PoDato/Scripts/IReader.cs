...
namespace PoDato {
	public interface IReader {
		...
		bool OptionalStringReadOnlyList(string name, ref IReadOnlyList<string> value);
		...
		bool OptionalStringProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<string>, new();
		...
		void RequiredStringReadOnlyList(string name, ref IReadOnlyList<string> value);
		...
		void RequiredStringProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<string>, new();
		...
		bool OptionalInt32ReadOnlyList(string name, ref IReadOnlyList<int> value);
		...
		bool OptionalInt32ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<int>, new();
		...
		void RequiredInt32ReadOnlyList(string name, ref IReadOnlyList<int> value);
		...
		void RequiredInt32ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<int>, new();
		...
		bool OptionalInt16ReadOnlyList(string name, ref IReadOnlyList<short> value);
		...
		bool OptionalInt16ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<short>, new();
		...
		void RequiredInt16ReadOnlyList(string name, ref IReadOnlyList<short> value);
		...
		void RequiredInt16ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<short>, new();
		...
		bool OptionalInt64ReadOnlyList(string name, ref IReadOnlyList<long> value);
		...
		bool OptionalInt64ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<long>, new();
		...
		void RequiredInt64ReadOnlyList(string name, ref IReadOnlyList<long> value);
		...
		void RequiredInt64ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<long>, new();
		...
		bool OptionalUInt32ReadOnlyList(string name, ref IReadOnlyList<uint> value);
		...
		bool OptionalUInt32ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<uint>, new();
		...
		void RequiredUInt32ReadOnlyList(string name, ref IReadOnlyList<uint> value);
		...
		void RequiredUInt32ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<uint>, new();
		...
		bool OptionalUInt16ReadOnlyList(string name, ref IReadOnlyList<ushort> value);
		...
		bool OptionalUInt16ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<ushort>, new();
		...
		void RequiredUInt16ReadOnlyList(string name, ref IReadOnlyList<ushort> value);
		...
		void RequiredUInt16ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<ushort>, new();
		...
		bool OptionalUInt64ReadOnlyList(string name, ref IReadOnlyList<ulong> value);
		...
		bool OptionalUInt64ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<ulong>, new();
		...
		void RequiredUInt64ReadOnlyList(string name, ref IReadOnlyList<ulong> value);
		...
		void RequiredUInt64ProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<ulong>, new();
		...
		bool OptionalSingleReadOnlyList(string name, ref IReadOnlyList<float> value);
		...
		bool OptionalSingleProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<float>, new();
		...
		void RequiredSingleReadOnlyList(string name, ref IReadOnlyList<float> value);
		...
		void RequiredSingleProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<float>, new();
		...
		bool OptionalDoubleReadOnlyList(string name, ref IReadOnlyList<double> value);
		...
		bool OptionalDoubleProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<double>, new();
		...
		void RequiredDoubleReadOnlyList(string name, ref IReadOnlyList<double> value);
		...
		void RequiredDoubleProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<double>, new();
		...
		bool OptionalByteReadOnlyList(string name, ref IReadOnlyList<byte> value);
		...
		bool OptionalByteProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<byte>, new();
		...
		void RequiredByteReadOnlyList(string name, ref IReadOnlyList<byte> value);
		...
		void RequiredByteProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<byte>, new();
		...
		bool OptionalSByteReadOnlyList(string name, ref IReadOnlyList<sbyte> value);
		...
		bool OptionalSByteProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<sbyte>, new();
		...
		void RequiredSByteReadOnlyList(string name, ref IReadOnlyList<sbyte> value);
		...
		void RequiredSByteProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<sbyte>, new();
		...
		bool OptionalBoolReadOnlyList(string name, ref IReadOnlyList<bool> value);
		...
		bool OptionalBoolProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<bool>, new();
		...
		void RequiredBoolReadOnlyList(string name, ref IReadOnlyList<bool> value);
		...
		void RequiredBoolProxyReadOnlyList<T>(string name, ref IReadOnlyList<T> value) where T : IReadProxy<bool>, new();
		...
		bool OptionalVector2ReadOnlyList(string name, ref IReadOnlyList<Vector2> value);
		...
		void RequiredVector2ReadOnlyList(string name, ref IReadOnlyList<Vector2> value);
		...
		bool OptionalVector3ReadOnlyList(string name, ref IReadOnlyList<Vector3> value);
		...
		void RequiredVector3ReadOnlyList(string name, ref IReadOnlyList<Vector3> value);
		...
		bool OptionalVector4ReadOnlyList(string name, ref IReadOnlyList<Vector4> value);
		...
		void RequiredVector4ReadOnlyList(string name, ref IReadOnlyList<Vector4> value);
		...
		bool OptionalQuaternionReadOnlyList(string name, ref IReadOnlyList<Quaternion> value);
		...
		void RequiredQuaternionReadOnlyList(string name, ref IReadOnlyList<Quaternion> value);
		...
		bool OptionalVector2IntReadOnlyList(string name, ref IReadOnlyList<Vector2Int> value);
		...
		void RequiredVector2IntReadOnlyList(string name, ref IReadOnlyList<Vector2Int> value);
		...
		bool OptionalVector3IntReadOnlyList(string name, ref IReadOnlyList<Vector3Int> value);
		...
		void RequiredVector3IntReadOnlyList(string name, ref IReadOnlyList<Vector3Int> value);
		...
		bool OptionalRectReadOnlyList(string name, ref IReadOnlyList<Rect> value);
		...
		void RequiredRectReadOnlyList(string name, ref IReadOnlyList<Rect> value);
		...
		bool OptionalRectIntReadOnlyList(string name, ref IReadOnlyList<RectInt> value);
		...
		void RequiredRectIntReadOnlyList(string name, ref IReadOnlyList<RectInt> value);
		...
		bool OptionalColorReadOnlyList(string name, ref IReadOnlyList<Color> value);
		...
		void RequiredColorReadOnlyList(string name, ref IReadOnlyList<Color> value);
		...
		bool OptionalColor32ReadOnlyList(string name, ref IReadOnlyList<Color32> value);
		...
		void RequiredColor32ReadOnlyList(string name, ref IReadOnlyList<Color32> value);
